...
Classifies uploaded documents and determines routing.
...
# Lazy-init to avoid circular imports at module load
_llm = None
...
def classify_document(
    ...
    system = "You are a legal document classifier. Return ONLY valid JSON — no explanation."
...
def determine_routing(classification: dict, has_existing_case: bool) -> str:
    """
    Returns: "add_to_existing" | "new_case" | "ask_user"
    """
