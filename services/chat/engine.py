...
#     print(f"✓ Citation processing took {citation_processing_time:.2f}s")
...
#     print(f"   - Citation processing: {citation_processing_time:.2f}s")
#     print(f"   - First enhanced chunk: {first_chunk_time:.2f}s")
#     print(f"   - Enhanced streaming: {stream_complete_time:.2f}s")
#     logger.info("=" * 80)
