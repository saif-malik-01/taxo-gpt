...
# #     print("\n" + "="*100)
# #     print(" "*30 + "🚀 OPTIMIZED CITATION ATTRIBUTION SYSTEM")
# #     print("="*100)
...
# #     # STEP 4 - ✅ MINIMAL PAYLOAD
# #     print("\n✨ STEP 4: RE-ATTRIBUTING CITATIONS (MINIMAL 6-FIELD PAYLOAD)")
# #     print("-"*100)
...
# #     print("\n" + "="*100)
# #     print(" "*25 + "✅ OPTIMIZED CITATION ATTRIBUTION COMPLETE")
# #     print("="*100 + "\n")
...
#         print("\n⚠️  No party pairs - returning original")
#         print("="*100 + "\n")
#         # Return generator that yields original response
