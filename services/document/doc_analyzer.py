...
def analyze_document(text: str, user_question: str = None) -> dict:
    ...
    """
    from services.document.doc_classifier import analyze_document as _analyze
...
def reextract_missed_issues(full_text: str, existing_issues: list) -> list:
    ...
    """
    from services.document.doc_classifier import reextract_missed_issues as _reextract
